...
![Alt text](Figures/MbiomeTaxonomyFinal.png)

## Pre-requisites
This workflow is compatible with Linux operative system. 
...
5. Create Picrust2 environment for Picrust2 Funtional analysis: 
```shell
...
(Note: as sample-id please write down the same name as the .fastq.gz file. Ex: sample01-2024-Control.fastq.gz --> sample01-2024-Control)
